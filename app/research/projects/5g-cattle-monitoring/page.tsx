...
export default function CattleMonitoringPage() {
  return (
    <div>
      {/* ヘッダーセクション */}
      <section className="bg-gray-100 py-16">
        <div className="container">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">5Gを活用した牛舎内の効率的な個体管理</h1>
            <p className="text-xl text-gray-600">総務省プロジェクト：牛舎内で5Gを活用した実証試験</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <div className="relative h-80 mb-8 rounded-lg overflow-hidden">
              <Image src="/images/goverment-project.png" alt="本試験の構成図" fill className="object-cover" />
            </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  北海道内では、乳牛の飼養戸数が減少傾向にあるなか、一戸あたりの飼養頭数は年々増加傾向にあり、搾乳や給餌などの労働負荷を軽減することができ、大規模経営に適したフリーストール牛舎の導入が進んでいます。一方で、フリーストール牛舎では、牛が牛舎内を自由に歩き回れるため、個体管理が難しいという課題があります。牧場主や従業員が日々獣医検診や健康管理などを行うために、数百頭も����中から対象の牛を特定する必要があり、さらなる作業効率化が求められています。
                </p>
              </div>
              ...
              <div className="flex justify-center mt-8">
                <Link href="/research/projects">
                  <Button variant="outline">研究プロジェクト一覧に戻る</Button>
                </Link>
              </div>
            </div>
          </div>
